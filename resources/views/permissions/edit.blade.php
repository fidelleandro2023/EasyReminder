    ...
    <div class="container mx-auto py-6">
        ...
        <form action="{{ route('permissions.update', $permission->id) }}" method="POST" class="bg-white p-6 rounded-lg shadow-md">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="name" id="name" value="{{ $permission->name }}" class="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring focus:border-blue-500" required>
                @error('name')
